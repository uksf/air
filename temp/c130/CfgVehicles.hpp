...
class CfgVehicles {
    ...
    class GVAR(base) : Plane_Base_F {
        ...
        displayname = "C-130J";
        faction = "CUP_B_GB";
        model = QPATHTOF(data\uksf_c130_base.p3d);
        ...
        thrustCoef[] = { 0.5, 0.8, 1, 1.3, 1.4, 1.2, 1, 0.9, 0.6, 0.5, 0.3, 0.1, 0 };
        airBrake = 1;
        ...
        class AnimationSources {
            ...
            class Damper_f_source {
                source = "damper";
                wheel = "wheel_f";
            };
            class Damper_m_l_source {
                source = "damper";
                wheel = "wheel_m_l";
            };
            class Damper_m_r_source {
                source = "damper";
                wheel = "wheel_m_r";
            };
            class Damper_b_l_source {
                source = "damper";
                wheel = "wheel_b_l";
            };
            class Damper_b_r_source {
                source = "damper";
                wheel = "wheel_b_r";
            };
            class Wheel_f_source {
                source = "wheel";
                wheel = "wheel_f";
            };
            class Wheel_m_l_source {
                source = "wheel";
                wheel = "wheel_m_l";
            };
            class Wheel_m_r_source {
                source = "wheel";
                wheel = "wheel_m_r";
            };
            class Wheel_b_l_source {
                source = "wheel";
                wheel = "wheel_b_l";
            };
            class Wheel_b_r_source {
                source = "wheel";
                wheel = "wheel_b_r";
            };
        };
        ...
        class Damage {
            tex[] = {};
            mat[] = {
                QPATHTOF(data\rvmat\c130j_sklo.rvmat),
                QPATHTOF(data\rvmat\c130j_sklo_damage.rvmat),
                QPATHTOF(data\rvmat\c130j_sklo_damage.rvmat),
                QPATHTOF(data\rvmat\c130j_sklo_in.rvmat),
                QPATHTOF(data\rvmat\c130j_sklo_in_damage.rvmat),
                QPATHTOF(data\rvmat\c130j_sklo_in_damage.rvmat),
                QPATHTOF(data\rvmat\c130j_body.rvmat),
                QPATHTOF(data\rvmat\c130j_body_damage.rvmat),
                QPATHTOF(data\rvmat\c130j_body_destruct.rvmat),
                QPATHTOF(data\rvmat\c130j_interior.rvmat),
                QPATHTOF(data\rvmat\c130j_interior_damage.rvmat),
                QPATHTOF(data\rvmat\c130j_interior_destruct.rvmat),
                QPATHTOF(data\rvmat\c130j_wings.rvmat),
                QPATHTOF(data\rvmat\c130j_wings_damage.rvmat),
                QPATHTOF(data\rvmat\c130j_wings_destruct.rvmat),
        ...
        class Wheels {
            ...
            class wheel_m_l : wheel_f {
                boneName = "wheel_m_l";
                boundary = "wheel_m_l_rim";
                center = "wheel_m_l_center";
                side = "left";
                steering = 0;
                ...
                maxCompression = 0.1;
                maxDroop = 0;
                suspForceAppPointOffset = "wheel_m_l_center";
                tireForceAppPointOffset = "wheel_m_l_center";
            };
            class wheel_m_r : wheel_m_l {
                boneName = "wheel_m_r";
                boundary = "wheel_m_r_rim";
                center = "wheel_m_r_center";
                side = "right";
                suspForceAppPointOffset = "wheel_m_r_center";
                tireForceAppPointOffset = "wheel_m_r_center";
            };
            class wheel_b_l : wheel_m_l {
                boneName = "wheel_b_l";
                boundary = "wheel_b_l_rim";
                center = "wheel_b_l_center";
                suspForceAppPointOffset = "wheel_b_l_center";
                tireForceAppPointOffset = "wheel_b_l_center";
            };
            class wheel_b_r : wheel_m_r {
                boneName = "wheel_b_r";
                boundary = "wheel_b_r_rim";
                center = "wheel_b_r_center";
                side = "right";
                suspForceAppPointOffset = "wheel_b_r_center";
                tireForceAppPointOffset = "wheel_b_r_center";
            };
        };
