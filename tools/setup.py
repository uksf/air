...
def main():
    ...
    print("""
  #######################################
  # Air Development Environment Setup #
  #######################################

  This script will create your Air dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your Air project folder:
    [Arma 3 installation directory]\\{} => Air project folder
    P:\\{}                              => Air project folder
